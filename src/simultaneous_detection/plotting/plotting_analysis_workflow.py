...
def main():
    ...
    fig, ax = plt.subplots(nrows = 3, ncols = 1, figsize = (4.1, 8))
    fig.subplots_adjust(left = 0.23, right = 0.93, top = 0.97, bottom = 0.08, hspace=0.6)
    ...
    ax[0].text(-0.3, 0.95, 'A',transform=ax[0].transAxes,fontsize=22, fontweight='bold')
    ax[1].text(-0.3, 0.95, 'B',transform=ax[1].transAxes,fontsize=22, fontweight='bold')
    ax[2].text(-0.3, 0.95, 'C',transform=ax[2].transAxes,fontsize=22, fontweight='bold')

    fig.text(x=0.35, y=0.675, s='1. Baseline correction', 
         fontsize=12, fontweight='bold', 
         ha='left', va='center')
    fig.text(x=0.35, y=0.65, s='2. Fitting', 
         fontsize=12, fontweight='bold', 
         ha='left', va='center')
    
    fig.text(x=0.22, y=0.335, s='3. Smoothing', 
         fontsize=12, fontweight='bold', 
         ha='left', va='center')
    fig.text(x=0.65, y=0.335, s='4. Differentiation', 
         fontsize=12, fontweight='bold', 
         ha='left', va='center')
